  ...
  <div class="max-w-7xl mx-auto py-6 px-4">
    ...
    <nav class="mb-4 text-sm">
      <ol class="flex items-center space-x-2 text-gray-500">
        ...
        <li class="text-gray-900">提交详情</li>
      </ol>
    </nav>
    ...
    <div v-else-if="data?.submission" class="space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div class="space-y-3">
              ...
              <div
                v-else-if="data.submission.status === 'PENDING'"
                class="text-center p-4 bg-yellow-50 rounded-lg"
              >
              ...
              <div
                v-else-if="data.submission.status === 'JUDGING'"
              ...
              <div
                v-else-if="data.submission.status === 'ERROR'"
      ...
      <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="flex space-x-4">
          ...
          <button
            v-if="
              data.submission.status === 'PENDING' || data.submission.status === 'JUDGING'
            "
...
onMounted(() => {
  const interval = setInterval(async () => {
    if (
      data.value?.submission?.status === "PENDING" ||
      data.value?.submission?.status === "JUDGING"
    ) {
      await refresh();
    } else {
